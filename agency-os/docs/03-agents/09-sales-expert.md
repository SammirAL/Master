...
| `mem_decisions` | Oui | Non | Décisions CEO passées sur les prix et offres (approbations, refus, conditions attachées) pour proposer de façon cohérente et ne pas resoumettre un refus à l'identique |
